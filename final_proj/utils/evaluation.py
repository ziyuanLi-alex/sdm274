...
class Evaluation():
    ...
    def calculate_accuracy(self, y_actual, y_pred):
        ...
        if len(y_actual) != len(y_pred):
            raise ValueError("Length mismatch between y_actual and y_pred")
        return np.mean(y_actual == y_pred)

    def calculate_recall(self, y_actual, y_pred, positive_label=None):
    ...
    def calculate_precision(self, y_actual, y_pred, positive_label=None):
    ...
    def calculate_f1_score(self, y_actual, y_pred, positive_label=None):
        if positive_label is None:
            positive_label = self.positive_label
    ...
    def evaluate(self, y_actual, y_pred, positive_label=None):
        if positive_label is None:
            positive_label = self.positive_label
